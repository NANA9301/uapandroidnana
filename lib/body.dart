    ...
    return ListView(
      ...
      children: <Widget>[
        Container(
            ...
            child: Image.asset("images/nana.jpg")),
        Text("NAMA    : Nana Maryana Agung Fauziyah", style: ukuran),
        Text("TTL     : Magetan, 09 Maret 2001", style: ukuran),
        Text("NIPP    : 20.20.04056", style: ukuran),
        Text(
            ...
            onPressed: () {
              showDialog(
                  ...
                  builder: (BuildContext context) => AlertDialog(
                        ...
                        content: const Text("WELCOME Nana Maryana"),
                        actions: <Widget>[
                          TextButton(
